...
contract GENTLEDOGGIESSERUM is ERC721Enumerable, Ownable {
 ...
 uint public nextMintId;
    ...
    constructor(
        string memory _name, string memory _symbol, address _layerZeroEndpoint, uint _startMintId, uint _endMintId)
